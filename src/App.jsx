    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 bg-primary-dark shadow-lg z-50">
        <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-3 md:py-4">
          <div className="flex items-center justify-between gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                <a
                  ...
                  className="bg-accent hover:bg-accent-light text-primary-dark font-semibold px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg transition-all duration-200 hover:scale-105 shadow-md text-xs sm:text-sm whitespace-nowrap"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-accent transition-colors duration-200 hidden sm:block"
                  aria-label="Facebook"
                >
          ...
          {/* Menu Mobile/Tablet */}
          <nav className="lg:hidden mt-2 sm:mt-3 flex flex-wrap gap-1.5 sm:gap-2">
            <button 
              onClick={() => scrollToSection('como-funciona')}
              className="text-white text-xs sm:text-sm hover:text-accent transition-colors px-1.5 sm:px-2 py-1"
            >
              Como funciona
            </button>
            <button 
      ...
      {/* ============================================
          ...
          ============================================ */}
      <section className="pt-16 sm:pt-20 md:pt-28 lg:pt-32 pb-12 sm:pb-16 md:pb-24 bg-gradient-to-b from-primary-dark to-primary-DEFAULT text-white">
