...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ============================================
          HEADER FIXO - APENAS LOGO E BOTÃO PROMOÇÕES
          ============================================ */}
      <header className="fixed top-0 left-0 right-0 bg-primary-dark shadow-lg z-50">
        <div className="container mx-auto px-3 py-2.5 sm:px-4 md:px-6 md:py-3 lg:py-4">
          {/* Linha principal: Logo + Botão CTA */}
          <div className="flex items-center justify-between gap-2 sm:gap-3">
            ...
            <div className="flex items-center flex-shrink-0 min-w-0">
              ...
              >
                <img 
                  src="/VOOS.png" 
                  alt="Voos Secretos" 
                  className="h-8 w-auto sm:h-10 md:h-14 lg:h-16 xl:h-20 max-w-[120px] sm:max-w-[150px] md:max-w-none"
                />
              </button>
            </div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 flex-shrink-0">
                <a
                  ...
                  className="bg-accent hover:bg-accent-light text-primary-dark font-semibold px-2.5 py-1.5 rounded-lg transition-all duration-200 hover:scale-105 shadow-md text-[10px] sm:text-xs whitespace-nowrap sm:px-3 md:px-4 md:py-2 md:text-sm"
                >
                  <span className="hidden md:inline">Quero receber promoções</span>
                  <span className="md:hidden">Promoções</span>
                </a>
                <a
                  href="https://www.facebook.com/profile.php?id=61584041600760"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-accent transition-colors duration-200 hidden md:block flex-shrink-0"
                  aria-label="Facebook"
                >
      ...
      {/* ============================================
          HERO SECTION (Seção Principal) - MOBILE FIRST
          ============================================ */}
      <section className="pt-16 pb-12 sm:pt-20 md:pt-28 md:pb-16 lg:pt-32 lg:pb-24 bg-gradient-to-b from-primary-dark to-primary-DEFAULT text-white">
        <div className="container mx-auto px-4 md:px-6">
          {/* Mobile: Stack vertical, Desktop: Grid 2 colunas */}
          <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-8 items-center">
            {/* Conteúdo de texto - Mobile First */}
            <div className="fade-in w-full order-1 md:order-1">
              <h2 className="text-2xl font-bold mb-4 leading-tight md:text-4xl md:mb-6 lg:text-5xl xl:text-6xl">
                As melhores promoções de passagens aéreas, antes de todo mundo.
              </h2>
              <p className="text-base mb-6 text-gray-200 leading-relaxed md:text-lg md:mb-8 lg:text-xl">
                Nós vasculhamos as companhias e agências para encontrar voos secretos com desconto e te avisar antes de esgotar.
              </p>

              {/* Botão WhatsApp com Redes Sociais - Mobile First */}
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:flex-wrap">
                <a
                  href={WHATSAPP_LINK}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-accent hover:bg-accent-light text-primary-dark font-semibold px-6 py-3 rounded-lg transition-all duration-200 hover:scale-105 text-base w-full md:w-auto"
                >
                  ...
                  <span>Receber ofertas no WhatsApp</span>
                </a>
            ...
            {/* Espaço para Imagens - Mobile First */}
            <div className="fade-in w-full order-2 md:order-2">
      ...
      {/* ============================================
          SEÇÃO: COMO FUNCIONA - MOBILE FIRST
          ============================================ */}
      <section id="como-funciona" className="py-12 md:py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl font-bold text-center mb-3 text-primary-dark md:text-3xl md:mb-4 lg:text-4xl">
            Como funciona
          </h2>
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto text-sm px-2 md:mb-12 md:text-base">
      ...
      {/* ============================================
          SEÇÃO: VANTAGENS - MOBILE FIRST
          ============================================ */}
      <section id="vantagens" className="py-12 md:py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl font-bold text-center mb-3 text-primary-dark md:text-3xl md:mb-4 lg:text-4xl">
      ...
      {/* ============================================
          SEÇÃO: COMPARAÇÕES DE PREÇOS - MOBILE FIRST
          ============================================ */}
      <section id="comparacoes" className="py-12 md:py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl font-bold text-center mb-3 text-primary-dark md:text-3xl md:mb-4 lg:text-4xl">
            Compare os Preços
          </h2>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-2 hover:bg-accent hover:text-white transition-all duration-200 hover:scale-110 hidden md:flex items-center justify-center md:p-3"
              aria-label="Anterior"
            >
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-2 hover:bg-accent hover:text-white transition-all duration-200 hover:scale-110 hidden md:flex items-center justify-center md:p-3"
              aria-label="Próximo"
            >
              <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div 
              ref={carouselRef}
              className="overflow-x-hidden pb-4 px-4 md:px-8 lg:px-12"
              ...
              <div className="flex gap-4 md:gap-6">
                ...
                {(tipoViagem === 'nacional' ? comparacoes : comparacoesInternacionais).map((comparacao, index) => (
                  <div 
                    ...
                    className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden flex-shrink-0 w-64 transform hover:scale-105 md:w-72"
                  >
                    {/* Imagem do destino com badge de desconto */}
                    <div className="relative h-32 bg-gray-200 overflow-hidden md:h-40">
                      <img 
                      ...
                      />
                      {/* Badge de desconto */}
                      <div className="absolute top-2 right-2 bg-accent text-primary-dark font-bold px-3 py-1 rounded-full text-xs shadow-lg md:text-sm">
                        -{comparacao.desconto}
                      </div>
                    </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="bg-gradient-to-br from-accent/20 to-accent/10 rounded-lg p-3 mb-3 border-2 border-accent">
                        ...
                        <p className="text-2xl font-bold text-primary-dark text-center md:text-3xl">
            ...
            {/* Setas para mobile (botões abaixo do carrossel) - Mobile First */}
      ...
      {/* ============================================
          SEÇÃO: FAQ (Perguntas Frequentes) - MOBILE FIRST
          ============================================ */}
      <section id="faq" className="py-12 md:py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          <h2 className="text-2xl font-bold text-center mb-3 text-primary-dark md:text-3xl md:mb-4 lg:text-4xl">
            Perguntas Frequentes
          </h2>
          <p className="text-center text-gray-600 mb-8 text-sm md:mb-12 md:text-base">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <button
                ...
                className="w-full px-4 py-3 text-left flex items-center justify-between hover:bg-gray-50 transition-colors md:px-6 md:py-4"
              >
                <span className="font-semibold text-primary-dark text-sm pr-2 md:text-base">
              ...
              {openFaq === 1 && (
                <div className="px-4 py-3 text-gray-600 border-t border-gray-100 text-sm md:px-6 md:py-4 md:text-base">
                  <p>
      ...
      {/* ============================================
          ...
          ============================================ */}
      <section id="contato" className="py-12 md:py-16 lg:py-24 bg-gradient-to-b from-primary-DEFAULT to-primary-dark text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-2xl font-bold mb-4 md:text-3xl md:mb-6 lg:text-4xl xl:text-5xl">
            Pronto para receber as próximas promoções secretas?
          </h2>
          <p className="text-base mb-6 max-w-2xl mx-auto px-2 md:text-lg md:mb-8 lg:text-xl" style={{ color: '#0A2647' }}>
            Entre no nosso grupo exclusivo do WhatsApp e comece a economizar hoje mesmo.
          </p>

          {/* Botão WhatsApp - Mobile First */}
          <div className="flex flex-col items-center gap-3 justify-center md:flex-row md:flex-wrap">
            <a
              href={WHATSAPP_LINK}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-accent hover:bg-accent-light text-primary-dark font-semibold px-6 py-3 rounded-lg transition-all duration-200 hover:scale-105 text-base w-full md:w-auto md:px-8 md:py-4 md:text-lg max-w-md"
            >
              <svg className="w-5 h-5 flex-shrink-0 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
              </svg>
      ...
      {/* ============================================
          FOOTER - MOBILE FIRST
          ============================================ */}
      <footer className="bg-primary-dark text-white py-6 md:py-8">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2 md:gap-8 md:mb-8 lg:grid-cols-3">
            {/* Coluna 1: Logo e descrição - Mobile First */}
            <div>
              <h3 className="text-xl font-bold mb-3 md:text-2xl md:mb-4">Voos Secretos</h3>
              <p className="text-gray-300 text-xs mb-4 md:text-sm">
