            ...
            <div className="fade-in w-full order-1 md:order-1">
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:flex-wrap">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-primary-dark font-semibold px-6 py-3 rounded-lg transition-all duration-200 hover:scale-105 text-base w-full md:w-auto"
                >
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col items-center gap-3 justify-center md:flex-row md:flex-wrap">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-primary-dark font-semibold px-6 py-3 rounded-lg transition-all duration-200 hover:scale-105 text-base w-full md:w-auto md:px-8 md:py-4 md:text-lg max-w-md"
            >
